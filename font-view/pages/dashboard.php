...
<style>
  ...
  .welcome-left h2 span { color: var(--accent); }
  .welcome-left p { font-size: 14px; color: var(--muted); }
  .welcome-right {
  ...
  .quick-btn.outline:hover { border-color: var(--accent); color: var(--accent); }
  ...
  .stat-icon.red    { background: rgba(255,94,26,.15);  color: var(--accent2); }
  ...
  .stat-badge.up   { background: rgba(34,197,94,.15);  color: #22c55e; }
  .stat-badge.down { background: rgba(239,68,68,.15);  color: #ef4444; }
  .stat-value {
    font-family: 'Bebas Neue', sans-serif;
    font-size: 30px; color: var(--text); letter-spacing: 1px;
  }
  ...
  .offer-item:hover { background: rgba(255,255,255,.02); }
  .offer-thumb {
    width: 44px; height: 44px; border-radius: 10px;
    background: linear-gradient(135deg, var(--accent), var(--accent2));
    display: flex; align-items: center; justify-content: center;
    font-size: 18px; color: #000; font-weight: 900; flex-shrink: 0;
  }
  .offer-info { flex: 1; }
  .offer-info h4 { font-size: 13px; font-weight: 600; color: var(--text); margin-bottom: 3px; }
  .offer-info p  { font-size: 11px; color: var(--muted); }
  .offer-discount {
    font-family: 'Bebas Neue', sans-serif;

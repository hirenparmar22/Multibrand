...
if (isset($_POST['add_category'])) {
    ...
    $insert_query = mysqli_query($conn, "
        INSERT INTO categories (category_name, category_image, slug, parent_id, image, color, icon, count, status, created_at)
        VALUES ('$category_name', '$category_image', '$slug', $parent_id, '$image_name', '$color', '$icon', 0, 'active', NOW())
    ");
...
<div class="wc-container">
    ...
    <div class="wc-left">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <label>Color</label>
            <input type="text" name="color" placeholder="primary / #ff0000">
        ...
        <table class="wc-table">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        <td><strong><?= $prefix . $row['category_name']; ?></strong></td>
                        <td>-</td>
                        <td><?= $row['slug'] ?? '-'; ?></td>
                        <td><?= $row['count']; ?></td>
                        <td><?= $row['icon'] ?? '-'; ?></td>
...
<style>
    * {
    ...
    .wc-left button:hover {
        opacity: 0.9;
        transform: translateY(-1px);
    }

    .wc-left button:active {

...
.pg-header h1 { font-size: 22px; font-weight: 700; color: #1e1b4b; }
.pg-header p  { font-size: 13px; color: #64748b; margin-top: 4px; }
...
.form-card h2 { font-size: 14px; font-weight: 600; color: #1e1b4b; margin-bottom: 18px; }
...
.color-wrap span { font-size: 12px; color: #94a3b8; font-family: monospace; }
...
.table-top { margin-bottom: 18px; }
.table-top h2 { font-size: 14px; font-weight: 600; color: #1e1b4b; }
...
.tile-info { display: flex; align-items: center; justify-content: space-between; gap: 6px; }
.tile-name { font-size: 13px; font-weight: 600; color: #1e293b; }
.tile-code {
...
.del-btn {
    ...
    background: #fff1f2; border: none; border-radius: 7px;
